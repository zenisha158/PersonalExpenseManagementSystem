<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="ExpenseTracker.Register" %>
...
<body>
    ...
    <div class="user__details">
      ...
      <div class="input__box">
        ...
        <asp:RegularExpressionValidator ID="ExpressionValidatorEmail" runat="server" ControlToValidate="TbEmail" ErrorMessage="Invalid Email Address" ValidationExpression="^([\w\.\-]+)@([\w\-]+)((\.(\w){2,3})+)$"></asp:RegularExpressionValidator>
      </div>
      <div class="input__box">
          ...
          <%--<asp:RegularExpressionValidator ID="ExpressionValidatorPass" runat="server" ControlToValidate="TbPassword" ErrorMessage="Password must contain minimum 8 characters and maximum 15 characters" ValidationExpression="^(?=.[A-Za-z])(?=.\d)(?=.[$@$!%#?&amp;])[A-Za-z\d$@$!%*#?&amp;]{8,}"></asp:RegularExpressionValidator>--%>
